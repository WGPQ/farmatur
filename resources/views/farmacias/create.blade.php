    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="f_nuevo_farmacia" method="POST" action="{{ route('farmacias.store') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="latitud" type="text" class="form-control" name="latitud"
                                    value="{{ old('latitud') }}" required autocomplete="latitud">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="longitud" type="text" class="form-control" name="longitud"
                                    value="{{ old('longitud') }}" required autocomplete="longitud">
                            </div>
                        </div>
