                ...
                <div class="card-body">
                    <form action="{{ route('usuarios.update',$usuario->id) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombre" type="text"
                                    ...
                                    value="{{ $usuario->nombre }}" required autocomplete="nombre" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text"
                                    ...
                                    value="{{ $usuario->cedula }}" required autocomplete="cedula" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    name="email" value="{{ $usuario->email }}" required autocomplete="correo">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="tipouser" value="{{ $usuario->tipouser }}">
